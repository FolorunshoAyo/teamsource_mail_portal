...
var ctx = (_document$getElementB = document.getElementById("big-line-chart")) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.getContext("2d");
if (ctx) {
  new Chart(ctx, {
    type: "line",
    data: {
...
var options = {
  ...
  xaxis: {
    categories: ["Recipients", "Delivered", "Click", "Unique Click", "Open", "Bounce"]
  }
};
if (document.querySelector("#campaign-report-stats")) {
  var campaignChart1 = new ApexCharts(document.querySelector("#campaign-report-stats"), options);
...
if (document.querySelector("#single-campaign-report-stats")) {
  var campaignChart2 = new ApexCharts(document.querySelector("#single-campaign-report-stats"), options);
